...
<div class="wp-emoji-reactions-container" data-post-id="<?php echo esc_attr($post_id); ?>">
    ...
    <div class="wp-emoji-reactions-title"><?php echo esc_html(get_option('wp_emoji_reactions_title_text', __('Reactions:', 'wp-emoji-reactions'))); ?></div>
    <?php endif; ?>
    <div class="wp-emoji-reactions-buttons">
        <?php foreach ($enabled_emojis as $key => $emoji) : ?>
            ...
            <button class="wp-emoji-reaction-button<?php echo $user_reaction === $key ? ' active' : ''; ?>" data-reaction="<?php echo esc_attr($key); ?>" title="<?php echo esc_attr(isset($custom_names[$key]) ? $custom_names[$key] : ucfirst($key)); ?>">
    ...
    <?php if ($user_reaction) : ?>
        <div class="wp-emoji-reactions-message">
            <?php 
            esc_html_e('You reacted with', 'wp-emoji-reactions'); 
